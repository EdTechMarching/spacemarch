          ...
          <div id="pop-up-text">
            ...
            <div className="pop-up-details">
              <div className="pop-up-img">
                <img alt="Image of the planet that was selected during game play" src="https://res.cloudinary.com/tinamarieg/image/upload/v1614967030/mars-4628918_640_2_1_kxaldk.jpg" />
              </div>
